This folder contains all the versions of the files which are used to create the final model results published in my thesis. There are plenty of other versions of these files which have not been included.

Here's a quick overview of how I ran the model.
